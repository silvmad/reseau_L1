...
<tr id="champ">
 <td><select name='article[]' onchange='prix(this);'>
  ...
  <option label='5' value='bsc'>Sirop de cerise (50cl)</option>œ
...
$res_cours = mysqli_query($con, "SELECT * FROM agricoulis.commandes WHERE id='$id'AND  (statut='Attente de paiement' OR statut='En cours de préparation');");
...
?>
	...
	<div id="comm_ter">
<?php
$res_ter = mysqli_query($con, "SELECT * FROM agricoulis.commandes WHERE id='$id'AND statut='Envoyée';");
