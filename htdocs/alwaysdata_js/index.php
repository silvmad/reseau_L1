...
if (isset($_POST['login']) && isset($_POST['mdp'])){
 ...
 $user_log = "176690_agri";
 $passe_log = "mdpagricoulis";
 $base_log = "assoagricoulis_site";
 ...
 $res_log = mysqli_query($con_log, "SELECT * FROM assoagricoulis_site.utilisateurs WHERE login='$log'");
	...
	<div id="chataigneraie"><!-- style="display : none"-->
	  ...
	  <?php
	   ...
	   #connection au serveur mysql
           $server = "mysql-assoagricoulis.alwaysdata.net";
    	   $user = "176690_usersonda";
    	   $passe = "mdpsondage";
    	   $base = "assoagricoulis_sondage";
	   ...
	   mysqli_query($con, "UPDATE assoagricoulis_sondage.creme SET nb_votes = nb_votes + 1 WHERE type='$vote';");
...
$res_cr = mysqli_query($con, "SELECT nb_votes FROM assoagricoulis_sondage.creme WHERE type='creme';");
$votes_cr = mysqli_fetch_array($res_cr);
#Récupération du nombre de votes pour 'delice'.
$res_del = mysqli_query($con, "SELECT nb_votes FROM assoagricoulis_sondage.creme WHERE type='delice';");
...
?>
    ...
    <!-- <script type="text/javascript" src="agricoulis.js" ></script>-->
