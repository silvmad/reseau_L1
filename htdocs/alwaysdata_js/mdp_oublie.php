...
if (! $con) echo "Pas de connexion : " . mysqli_connect_error();
    ...
    //on a reçu un mail
     ...
     $res = mysqli_query($con, "SELECT * FROM assoagricoulis_site.utilisateurs WHERE mail='$mail';");
     ...
     if (mysqli_num_rows($res) > 0) {
      ...
      mysqli_query($con, "INSERT INTO assoagricoulis_site.reset_mdp VALUES ('$mail', '$chaine', '$id', '$time');");
      //envoi du mail
