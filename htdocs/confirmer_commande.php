...
/*$array = [
pcm => nettoyer($_POST['pcm']),
ccm => nettoyer($_POST['ccm']),
pdc => nettoyer($_POST['pdc']),
cdc => nettoyer($_POST['cdc']),
pcn => nettoyer($_POST['pcn']),
pado => nettoyer($_POST['pado']),
pgg => nettoyer($_POST['pgg']),
bsc => nettoyer($_POST['bsc']),
tcal => nettoyer($_POST['tcal']),
tcam => nettoyer($_POST['tcam']),
ttil => nettoyer($_POST['ttil']),
tasdl => nettoyer($_POST['tasdl']),
tdoedm => nettoyer($_POST['tdoedm']),
talhdg => nettoyer($_POST['talhdg']),
tecel => nettoyer($_POST['tecel']),
tpf => nettoyer($_POST['tpf']),
tct => nettoyer($_POST['tct']),
tla => nettoyer($_POST['tla']),
tplm => nettoyer($_POST['tplm']),
nom => nettoyer($_POST['nom']),
prenom => nettoyer($_POST['prenom']),
adresse => nettoyer($_POST['adresse']),
code_postal => nettoyer($_POST['code_postal']),
ville => nettoyer($_POST['ville']),
time => time() ];*/ //on ajoute le temps à la commande pour éviter de l'écrire deux fois dans la base
//si l'utilisateur renvoie deux fois les éléments



//$chaine = "INSERT INTO agricoulis.commandes VALUES ($id, {$_POST['pcm']}, {$_POST['ccm']}, {$_POST['pdc']}, {$_POST['cdc']}, {$_POST['pcn']}, {$_POST['pado']}, {$_POST['pgg']}, {$_POST['bsc']}, {$_POST['tcal']}, {$_POST['tcam']}, {$_POST['ttil']}, {$_POST['tasdl']}, {$_POST['tdoedm']}, {$_POST['talhdg']}, {$_POST['tecel']}, {$_POST['tpf']}, {$_POST['tct']}, {$_POST['tla']}, {$_POST['tplm']}, $prix_total, '{$_POST['nom']}', '{$_POST['prenom']}', '{$_POST['adresse']}', '{$_POST['code_postal']}', '{$_POST['ville']}', \"Attente de paiement\");";
//$chaine = "INSERT INTO agricoulis.commandes VALUES ($id, $pcm, $ccm, $pdc, $cdc, $pcn, $pado, $pgg, $bsc, $tcal, $tcam, $ttil, $tasdl, $tdoedm, $talhdg, $tecel, $tpf, $tct, $tla, $tplm, $prix_total, $nom, $prenom, $adresse, $code_postal, $ville, 'Attente de paiement');";
//echo $chaine;
//$res = mysqli_query($con, "INSERT INTO agricoulis.commandes VALUES ($id, {$_POST['pcm']}, {$_POST['ccm']}, {$_POST['pdc']}, {$_POST['cdc']}, {$_POST['pcn']}, {$_POST['pado']}, {$_POST['pgg']}, {$_POST['bsc']}, {$_POST['tcal']}, {$_POST['tcam']}, {$_POST['ttil']}, {$_POST['tasdl']}, {$_POST['tdoedm']}, {$_POST['talhdg']}, {$_POST['tecel']}, {$_POST['tpf']}, {$_POST['tct']}, {$_POST['tla']}, {$_POST['tplm']}, $prix_total, '{$_POST['nom']}', '{$_POST['prenom']}', '{$_POST['adresse']}', '{$_POST['code_postal']}', '{$_POST['ville']}', 'Attente de paiement');");
?>
