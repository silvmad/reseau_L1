...
if (isset($_POST['suppr'])) mysqli_query($con, "DELETE FROM agricoulis.commandes WHERE num='{$_POST['num']}';");
if (isset($_POST['nouveau_statut']))
   mysqli_query($con, "UPDATE agricoulis.commandes SET statut='{$_POST['nouveau_statut']}' WHERE num='{$_POST['num']}';");
?>
<!Doctype html>
<html>
...
<?php
$res_cours = mysqli_query($con, "SELECT * FROM agricoulis.commandes WHERE (statut='Attente de paiement' OR statut='En cours de préparation');");
...
<?php
$res_ter = mysqli_query($con, "SELECT * FROM agricoulis.commandes WHERE statut='Envoyée';");
